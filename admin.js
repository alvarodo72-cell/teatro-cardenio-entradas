...
function showOrder(id){const o=orders.find(x=>x.id===id);if(!o)return;const isInv=(o.numero_pedido||'').startsWith('TAQ-')&&Number(o.total)===0;renderTicketDocuments($('ticketsList'),o.tickets||[],eventInfo()?.text||'',o.numero_pedido,isInv);$('ticketOverlay').classList.remove('hidden');}
